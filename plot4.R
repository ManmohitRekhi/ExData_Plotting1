...
plot(datetime, dataTable$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(datetime, dataTable$Voltage, xlab = "datetime", type = "l", ylab = "Global Active Power")
...
plot(datetime, dataTable$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
